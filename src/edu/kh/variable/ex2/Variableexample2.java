...
public class Variableexample2 {
	...
	public static void main(String[]args) {
		...
		short shortNum = 32767; //변수 선언 및 초기화
		// 정수 자료형 기본형! (short, byte 옛날코드의 잔재)
		 ...
		 * 'B' 문자 그대로가 대입되면 변수에 66으로 변화되서 저장
		...
		// 변수 명명 규칙
		// 1. 대소문자구분O, 길이제한X
		int adjfleiajfldjlfjeawfleajflef;
		int adjfleiajfldjlfjeawfleajfleF;
		...
		int int_number; // 자바는 카멜 표기법 쓰기때문에, _작성 안함
	                    // _ 작성표기법은 DB에서 사용
		
		// 5. 카멜표기법
		// -> 변수명 작성 시 여러 단어를 이어서 작성하는 경우
		// 		띄어쓰지않고 후속단어 첫 글자를 대문자로 작성
